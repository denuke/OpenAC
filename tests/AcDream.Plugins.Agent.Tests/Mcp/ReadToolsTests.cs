...
public sealed class ReadToolsTests
{
    ...
    [InlineData("explore", """{"tour":true}""", "explore tour")]
    [InlineData("explore", """{"tour":true,"end":" 24.30537 -101.10833 ","limit":20}""", "explore tour to 24.30537 -101.10833 limit 20")]
    ...
    [InlineData("explore", """{"tour":"yes"}""")]
    [InlineData("explore", """{"end":"24.3 -101.1"}""")]
